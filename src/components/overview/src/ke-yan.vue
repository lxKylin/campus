    ...
    series: [
      {
        ...
        data: [
          { value: 50, name: '市级', itemStyle: { color: 'pink' } }, //数据、名称以及颜色
          { value: 30, name: '省级', itemStyle: { color: '#73ACFF' } }, //数据、名称以及颜色
          { value: 10, name: '国家级', itemStyle: { color: '#FD866A' } } //数据、名称以及颜色
        ]
      }
    ]
  }
